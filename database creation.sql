...
INSERT INTO Author (Author_ID, Name, Nationality, Birth_date)
VALUES 
    (1, 'Jane Austen', 'British', '1775-12-16'),
    (2, 'Ernest Hemingway', 'American', '1899-07-21'),
    (3, 'George Orwell', 'British', '1903-06-25'),
    (4, 'Scott Fitzgerald', 'American', '1896-09-24'),
    (5, 'J.K. Rowling', 'British', '1965-07-31'),
    (6, 'Mark Twain', 'American', '1835-11-30'),
    (7, 'Leo Tolstoy', 'Russian', '1828-09-09'),
    (8, 'Virginia Woolf', 'British', '1882-01-25'),
    (9, 'Gabriel Márquez', 'Colombian', '1927-03-06'),
    (10, 'Charles Dickens', 'British', '1812-02-07'),
    (11, 'Harper Lee', 'American', '1926-04-28'),
    (12, 'Oscar Wilde', 'Irish', '1854-10-16'),
    (13, 'William Shakespeare', 'British', '1564-04-26'),
    (14, 'Franz Kafka', 'Czech', '1883-07-03'),
    (15, 'James Joyce', 'Irish', '1882-02-02'),
    (16, 'J.R.R. Tolkien', 'British', '1892-01-03'),
    (17, 'Emily Brontë', 'British', '1818-07-30'),
    (18, 'Toni Morrison', 'American', '1931-02-18'),
    (19, 'Fyodor Dostoevsky', 'Russian', '1821-11-11'),
    (20, 'Lucas Piki', 'British', '1847-10-16');
